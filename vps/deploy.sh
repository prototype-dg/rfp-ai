...
echo "▶ Deploying pdf-render service (v12) to ${REMOTE}"
...
if [ "${VERSION}" = "12" ]; then
  echo "✅ pdf-render is v12 — header fixed (single logo, RFP ref in white row), footer table layout, looser page-break rules"
else
  echo "⚠️  Expected version 12, got '${VERSION}'"
