...
echo "▶ Deploying pdf-render service (v8) to ${REMOTE}"
...
if [ "${VERSION}" = "8" ]; then
  echo "✅ pdf-render is v8 — background colors fixed, topo SVG overflow fixed"
else
  echo "⚠️  Expected version 8, got '${VERSION}'"
