...
echo "▶ Deploying pdf-render service (v7) to ${REMOTE}"
...
if [ "${VERSION}" = "7" ]; then
  echo "✅ pdf-render is v7 — split preview/PDF rendering, Puppeteer HF active"
else
  echo "⚠️  Expected version 7, got '${VERSION}'"
