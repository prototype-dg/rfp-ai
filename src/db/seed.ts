  ...
  const vendors = [
    {
      ...
      specializations: 'Custom software development; AI/ML development; Data platforms; Managed services; IT staff augmentation',
      certifications: 'Current supplier — 3 projects completed, working for past 12 months',
      erp_experience: 'Global software engineering firm delivering end-to-end digital solutions. TRN: 1001234567, Dubai',
    },
    {
      name: 'EPAM Systems',
      category: 'IT Consulting',
      ...
      specializations: 'Custom software development; AI & data platforms; Cloud migration; Managed services; Staff augmentation',
      certifications: '',
      erp_experience: 'Leading digital transformation and software engineering company. TRN: 1002345678, Abu Dhabi',
    },
    {
