...
export async function seedVendors(db: D1Database) {
  ...
  const vendors = [
    ...
    { name: 'Oracle UAE', category: 'IT & Digital Transformation', country: 'UAE', size: 'Large', contact_name: 'Sarah Johnson', contact_email: 'sjohnson@oracle.com', specializations: 'ERP,Oracle Cloud,Oracle EBS,Government,Finance,Procurement', certifications: 'ISO 27001,ISO 9001', erp_experience: 'Government sector ERP - 15+ years' },
    ...
    { name: 'Andersen Lab', category: 'IT Consulting', country: 'UAE', size: 'Medium', contact_name: 'David Gibert', contact_email: 'd.gibert@andersenlab.com', specializations: 'ERP,Custom Development,Integration,Government,Oracle EBS', certifications: 'ISO 9001,CMMI Level 3', erp_experience: 'Government ERP implementations - 8 years' },
    ...
    { name: 'JD Edwards UAE', category: 'IT & Digital Transformation', country: 'UAE', size: 'Large', contact_name: 'Fatima Al Balushi', contact_email: 'fbalushi@oracle.com', specializations: 'ERP,JD Edwards,Oracle EBS,Government,Distribution', certifications: 'ISO 27001', erp_experience: 'Government and utilities - 14 years' },
