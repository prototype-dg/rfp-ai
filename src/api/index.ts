...
const WORKER_VERSION = '2026-08-15-v71'  // v71: Upload RFP modal simplified (no PDF preview in modal); Generate tab shows uploaded PDF in right panel, pre-filled fields in left form, blue info banner
