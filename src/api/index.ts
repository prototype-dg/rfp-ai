...
// GET /rfps/:id/pdf — returns a print-ready HTML page that auto-triggers browser print dialog
// This preserves the exact HTML/CSS layout generated by the LLM (letterhead, tables, fonts, etc.)
...
async function sendRealEmail(
  ...
  // Note: email is sent without PDF attachment — the broken generateRfpPdf() renderer
  // produced corrupted layout (left-half clipping). The invitation body already includes
  // the submission portal URL so vendors have full access to the RFP.
